...
static constexpr auto qt_meta_stringdata_ZN12SignUpDialogE = QtMocHelpers::stringData(
    "SignUpDialog",
    "onBrowsePicture",
    "",
    "onSubmit"
...
Q_CONSTINIT static const uint qt_meta_data_ZN12SignUpDialogE[] = {
...
Q_CONSTINIT const QMetaObject SignUpDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12SignUpDialogE.offsetsAndSizes,
    qt_meta_data_ZN12SignUpDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12SignUpDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<SignUpDialog, std::true_type>,
        // method 'onBrowsePicture'
...
void SignUpDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onBrowsePicture(); break;
...
void *SignUpDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12SignUpDialogE.stringdata0))
