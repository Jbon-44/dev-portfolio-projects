...
static constexpr auto qt_meta_stringdata_ZN10ScoreBoardE = QtMocHelpers::stringData(
    "ScoreBoard",
    "death",
    "",
    "gameOver",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10ScoreBoardE[] = {
...
Q_CONSTINIT const QMetaObject ScoreBoard::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10ScoreBoardE.offsetsAndSizes,
    qt_meta_data_ZN10ScoreBoardE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10ScoreBoardE_t,
        // Q_OBJECT / Q_GADGET
...
void ScoreBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ScoreBoard::*)();
            if (_q_method_type _q_method = &ScoreBoard::death; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ScoreBoard::*)(int );
            if (_q_method_type _q_method = &ScoreBoard::gameOver; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *ScoreBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10ScoreBoardE.stringdata0))
