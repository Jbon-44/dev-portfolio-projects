...
static constexpr auto qt_meta_stringdata_ZN8RaindropE = QtMocHelpers::stringData(
    "Raindrop",
    "lostLife",
    "",
    "rainfall",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8RaindropE[] = {
...
Q_CONSTINIT const QMetaObject Raindrop::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8RaindropE.offsetsAndSizes,
    qt_meta_data_ZN8RaindropE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8RaindropE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Raindrop, std::true_type>,
        // method 'lostLife'
...
void Raindrop::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Raindrop::*)();
            if (_q_method_type _q_method = &Raindrop::lostLife; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Raindrop::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8RaindropE.stringdata0))
