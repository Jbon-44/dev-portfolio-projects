...
static constexpr auto qt_meta_stringdata_ZN5CloudE = QtMocHelpers::stringData(
    "Cloud",
    "cloudMovement",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5CloudE[] = {
...
Q_CONSTINIT const QMetaObject Cloud::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5CloudE.offsetsAndSizes,
    qt_meta_data_ZN5CloudE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5CloudE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Cloud, std::true_type>,
        // method 'cloudMovement'
...
void *Cloud::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5CloudE.stringdata0))
