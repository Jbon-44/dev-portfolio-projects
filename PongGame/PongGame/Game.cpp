...
Game::Game()
    : window(sf::VideoMode(800, 600), "Pong"),
      leftPaddle(50.f, 300.f - 50.f, "paddle_texture.jpeg"),
      rightPaddle(750.f - 25.f, 300.f - 50.f, "paddle_texture.jpeg"),
      ball(400.f, 300.f, "fireball_texture.jpeg"),
    ...
    // Load font
    if (!font.loadFromFile("BUBBLEGUMS.TTF")) {
